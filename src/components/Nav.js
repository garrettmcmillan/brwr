                ...
                >
                    ...
                    <NavImports.Navbar.Collapse  onToggle className="my-0">
                        <NavImports.Nav onClick={this.setNavExpanded} className="float-right nav-dropdown my-0">
                            <NavImports.Nav.Link as={Link}  to="/about" href="/brwr/about" className="nav-dropdown-item">
                                About.
                            </NavImports.Nav.Link>
                            <NavImports.Nav.Link as={Link}  to="/" href="/" className="nav-dropdown-item">
                                Calculator.
                            </NavImports.Nav.Link>
                            <NavImports.Nav.Link as={Link}  to="/guides" href="/brwr/guides" className="nav-dropdown-item">
                                Brew Guides.
                            </NavImports.Nav.Link>
